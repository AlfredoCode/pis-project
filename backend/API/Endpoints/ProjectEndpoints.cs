...
public class ProjectEndpoints : IEndpointDefinition
{
    ...
    {
        group.MapGet("/projects", async Task<IEnumerable<Project>> (ProjectService projects, string? course = null) =>
        {
        ...
        group.MapGet("/projects/{id}", async Task<Results<Ok<Project>, NotFound>> (ProjectService projects, int id) =>
        {
        ...
        group.MapPost("/projects", async Task<Results<Created<Project>, BadRequest<string>>> (ProjectService projects, Project project) =>
        {
            try
            {
        ...
        group.MapPut("/projects/{id}", async Task<Results<Ok<Project>, BadRequest<string>>> (ProjectService projects, int id, Project project) =>
        {
            project.Id = id;
            try
            {
