...
namespace PRegSys.DAL.Migrations
{
    ...
    [Migration("20250413192731_AddAllRemainingEntities")]
    partial class AddAllRemainingEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.SignRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_sign_requests");

                    b.HasIndex("StudentId")
                        .HasDatabaseName("ix_sign_requests_student_id");

                    b.HasIndex("TeamId")
                        .HasDatabaseName("ix_sign_requests_team_id");

                    b.ToTable("sign_requests", (string)null);
                });
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.SignRequest", b =>
                {
                    b.HasOne("PRegSys.DAL.Entities.Student", "Student")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sign_requests_students_student_id");
                    ...
                    b.HasOne("PRegSys.DAL.Entities.Team", "Team")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sign_requests_teams_team_id");
