...
namespace PRegSys.DAL.Migrations
{
    ...
    [Migration("20250427174751_MultipleSolutions")]
    partial class MultipleSolutions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Capacity = 5,
                            Course = "IZP",
                            Deadline = NodaTime.Instant.FromUnixTimeTicks(17040671990000000L),
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.SignUpRequest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = NodaTime.Instant.FromUnixTimeTicks(16935552000000000L),
                            State = 0,
                            StudentId = 3,
                            TeamId = 1
                        });
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.Solution", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            File = new byte[] { 111, 108, 100 },
                            ProjectId = 1,
                            SubmissionDate = NodaTime.Instant.FromUnixTimeTicks(16967484000000000L),
                            TeamId = 1
                        },
                        new
                        {
                            Id = 2,
                            EvaluationId = 1,
                            File = new byte[] { 110, 101, 119 },
                            ProjectId = 1,
                            SubmissionDate = NodaTime.Instant.FromUnixTimeTicks(16969392000000000L),
                            TeamId = 1
                        });
                });
