...
namespace PRegSys.DAL.Migrations
{
    ...
    [Migration("20250427093006_AddTeamSolution")]
    partial class AddTeamSolution
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.Solution", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            File = new byte[] { 0 },
                            ProjectId = 1,
                            SubmissionDate = NodaTime.Instant.FromUnixTimeTicks(16961616000000000L),
                            TeamId = 1
                        });
                });
            ...
            modelBuilder.Entity("PRegSys.DAL.Entities.Solution", b =>
                {
                    ...
                    b.HasOne("PRegSys.DAL.Entities.Team", "Team")
                        .WithOne("Solution")
                        .HasForeignKey("PRegSys.DAL.Entities.Solution", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
